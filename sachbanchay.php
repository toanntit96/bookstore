...
$sql1="SELECT * FROM product ORDER BY product.soluongnguoimua DESC LIMIT 0 , 20";
...
$sql="SELECT * FROM product ORDER BY product.soluongnguoimua DESC LIMIT 0 , 10";?>
<div class="titlebook"> <span> Sách bán chạy</span></div>
